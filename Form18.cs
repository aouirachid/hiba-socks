...
namespace FD_STOCK
{
    public partial class lemb : Form
    {
        ...
        private void lemb_Load(object sender, EventArgs e)
        {
            bd.Open();
            Remplir();
        }
        ...
        private void exportBtn_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.FileName = "EXPORTAION LISTE EMBALLAGES " + DateTime.Now.ToString("yyyy_MM_dd") + ".csv";
