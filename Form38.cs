    ...
    public partial class eg : Form
    {
        ...
        private void Enregistrer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bd.Open();
                    SqlCommand cmd = new SqlCommand("insert into entreeg values('" + teg.Text + "','" + tdee.Text + "','" + npe.Text + "','" + ddee.Value.ToString() + "','" + epe.Text + "','" + noce.Text + "')", bd);
                    cmd.ExecuteNonQuery();
                    ...
                    {
                        SqlCommand cmb = new SqlCommand("insert into cheque values('" + tableau2.Rows[i].Cells[0].Value.ToString() + "','" + tableau2.Rows[i].Cells[1].Value.ToString() + "','" + tableau2.Rows[i].Cells[2].Value.ToString() + "','" + nf.Text + "','" + ndee.ToString() + "','" + 1 + "')", bd);
                        cmb.ExecuteNonQuery();
                    }
