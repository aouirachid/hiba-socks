...
namespace FD_STOCK
{
    public partial class ns : Form
    {
        ...
        static string ConvertToWords(int number)
        {
            ...
            if (number < 80)
                return "soixante-" + ConvertToWords(number - 60);
            ...
            if (number < 90)
            {
                ...
                if (remainder == 0)
                    ...
                    return "quatre-vingt-" + ConvertToWords(remainder);
            }

            if (number < 100)
            {
                return "quatre-vingt-" + ConvertToWords(number - 80);
            }
        ...
        static string ConvertToWords(double number)
        {
            ...
            // Ajout du mot "virgule" entre la partie entière et fractionnaire
            string separator = (integerPart != 0 && fractionalPart != 0) ? " dirhams et " : "";
            ...
            if (fractionalPart == 0)
                ...
                return integerPartWords + separator + fractionalPartWords + " centimes";
        }
